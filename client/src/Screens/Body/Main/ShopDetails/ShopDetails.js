...
const columns =[
    {headerName:'Action', field:'_id',cellRendererFramework:function(params){
        return(<>
    ...
    return(
        <>
            ...
            <input {...register("phone", { required: true, maxLength: 20, })} placeholder='Phone' />
            <input {...register("email", { required: true, maxLength: 20, })} placeholder='Email' />
            <input type='file' {...register("Image", { required: true, maxLength: 20, })} placeholder='Image' multiple />
